...
public class terroristcar extends screenobject{
    static List<ImageView> list = new ArrayList<>() ;
    Timeline timeline;
    private final int speed;
    int locationx , locationy ;

    public terroristcar(int x, Image img , int speed ) {
        super(x, -150 , img);
        this.speed= speed;
    ...
    public void shoot (int speed , Pane pane ){
        ...
        // Now create a new terroristbomb with the current positions
        terroristbomb pl = new terroristbomb((int)currentX-10 , (int)currentY, new Image(getClass().getResourceAsStream("images/bomb.gif")), speed);
        pl.addtopane(pane);
